    ...
    <footer className="bg-black text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/courses" className="text-gray-400 hover:text-red-500">
                  Courses
                </Link>
              </li>
              <li>
                <Link to="/socials" className="text-gray-400 hover:text-red-500">
                  Socials
                </Link>
              </li>
              <li>
                <Link to="/vvip" className="text-gray-400 hover:text-red-500">
                  VVIP Access
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="https://instagram.com/fxkiids"
                target="_blank"
              ...
              <a
                href="https://twitter.com/fxkiids"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gray-800 hover:bg-red-500 w-10 h-10 rounded-full flex items-center justify-center transition-colors"
              >
              ...
              <a
                href="https://youtube.com/fxkiids"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gray-800 hover:bg-red-500 w-10 h-10 rounded-full flex items-center justify-center transition-colors"
              >
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} FXKIIDS. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
